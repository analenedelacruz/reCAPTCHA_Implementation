<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($response_data->successfully) {

            //Sanitize the data from the form input
            ...
            echo "<script>alert('The reCAPTCHA verification has failed. Please try again.'); window.location.href = 'login.php';</script>";
            exit();
        }
    } 
    ?>
